...
<template>
    <div class="p-4 mx-auto prose md:px-6 prose-indigo sm:rounded-md">
        ...
        <ul>
            ...
            <li>
                Routing using vue-router. See
                <router-link to="/demo/">demo page</router-link>. (Also
        ...
        <p>
            ...
            adds custom typed variables
            which you can easily use and modify to your needs.
        </p>
        ...
        <p>
            E2E coverage is a bit trickier to do because of the way Vite works. Typical Vite pipelines don't use babel at
            all which is needed above
            for automatically instrument the transpilated code. Vite is powered by eslint which has decided
